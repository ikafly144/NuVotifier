...
public class SpongeConfig {
    ...
    public String host = Sponge.server().boundAddress().isPresent() ? Sponge.server().boundAddress().get().getAddress().getHostAddress() : "0.0.0.0";
    ...
    public static class Forwarding {
        ...
        @Setting("Sets whether to set up a remote method for fowarding. Supported methods:\n" +
